		...
		<>
			...
			<Container spacing>
				...
				<p>
					...
					, die auf der Startseite verwendeten Fotos sind unsere eigenen.
				</p>
				<h3>Design und Umsetzung</h3>
				<p>
					Diese Website und das dazugehörige CMS haben wir selbst entwickelt,
					der Code dazu ist unter{" "}
					<ExternalLink href="https://github.com/lukasweidich/quikk" color>
						github.com/lukasweidich/quikk
					</ExternalLink>{" "}
					einsehbar.
				</p>
			</Container>
